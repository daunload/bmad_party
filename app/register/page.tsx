          ...
          <div className="rounded-2xl border border-gray-200 bg-white shadow-xl">
            ...
            <div className="border-b border-gray-100 px-8 py-8 text-center">
              <div className="mb-4 flex justify-center">
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-accent-500 to-primary-500 text-3xl shadow-lg shadow-accent-500/20">
                  ✨
                </div>
              </div>
